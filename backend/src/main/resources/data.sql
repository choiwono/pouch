...
values(1,'jaehee@gmail.com','박재희','jj','$2a$10$J8xwB2rAcEUdXJltVzYuk.Sf.5fZ03ukNhd.l7FLMoFZyt2q2KQSm',NOW());

insert into account (id,email,name,nick_name,passwd,reg_date)
values(2,'treasureb1330@gmail.com','최원오','choiwono2','$2a$10$J8xwB2rAcEUdXJltVzYuk.Sf.5fZ03ukNhd.l7FLMoFZyt2q2KQSm',NOW());

insert into account (id,email,name,nick_name,passwd,reg_date)
values(3,'admin','최원오','choiwono2','$2a$10$J8xwB2rAcEUdXJltVzYuk.Sf.5fZ03ukNhd.l7FLMoFZyt2q2KQSm',NOW());

insert into account (id,email,name,nick_name,passwd,reg_date)
values(4,'james@gmail.com','James','toto','$2a$10$J8xwB2rAcEUdXJltVzYuk.Sf.5fZ03ukNhd.l7FLMoFZyt2q2KQSm',NOW());
...
INSERT INTO link(id,link_option,email,src,content,reg_date, repository,tags_name,title,url,account_id,category_id)
...
INSERT INTO link(id,link_option,email,src,content,reg_date, repository,tags_name,title,url,account_id,category_id)
VALUES(3,1,'jaehee@gmail.com','','',NOW(),0,'java,OOP','[Programming] 객체 지향 프로그래밍이란?', 'https://jaehee0145.github.io/programming/',1,3);
INSERT INTO link(id,link_option,email,src,content,reg_date, repository,tags_name,title,url,account_id,category_id)
VALUES(4,1,'jaehee@gmail.com','','',NOW(),0,'web','부스트코스_웹 프로그래밍', 'https://www.edwith.org/boostcourse-web',1,3);
INSERT INTO link(id,link_option,email,src,content,reg_date, repository,tags_name,title,url,account_id,category_id)
VALUES(5,1,'jaehee@gmail.com','','',NOW(),0,'java','TCP School', 'http://tcpschool.com/',1,3);
