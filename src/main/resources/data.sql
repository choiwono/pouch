...
INSERT INTO account_category (id,category_name,reg_date,ordering,account_id)
Values(1,'프로그래밍',NOW(),1,1);

INSERT INTO board(id,board_option,email, reg_date, repository,title,url,account_id,account_category_id)
